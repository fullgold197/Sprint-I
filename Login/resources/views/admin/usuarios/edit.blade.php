        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="matricula" name="matricula" required maxlength="20" value="{{$usuario->nombres}} {{$usuario->ap_paterno}} {{$usuario->ap_materno}} " disabled>
            </div>
